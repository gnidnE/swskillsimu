...
# 23.May.2022    
- Added Erwin's Lvl 72 Skill Damage numbers for level 1 (only Jin missing now)

# 17.May.2022    
- Fixed Jin's Frenzy Icon not showing
...
# 14.May.2022    
- Fixed Ephnels AirBurst left Extension preview on .webm
...
# 20.November.2021   
- Translated Nabi's & Chii's whole Skill Page
...
## Authors note: 
    There are a few Skill stats for Chii missing but this time I made a list.
...
# 01.October.2021   
- Added new reworked Iris Skills:
...
# 27.September.2021 
- Fixed/Added some minor translations to Nabi/Stella (More to follow)
- Changed Ephnel's name
- Changed some minor translations for Stella

# 07.September.2021 
- Added 5th Skill point to eveyones Lvl62 Skill besides Stella (Must have overlooked it)
- Fixed/Added some minor translations to Nabi (More to follow)

# 05.August.2021    
- Changed aspect ratio for Stella's Skill previews from 1:1 -> 4:3
## Authors note:
...
- Fixed Stella's Phantom Release Skill preview from being sped up. (if there are other previews sped up, let me know)
## Authors note:
...
# 02.January.2021
- Added Lee Nabi (thanks to Myleia for the amazing Banner and everyone who provided me with the correct stats.)
...
# 15.May.2020       
- Switched to New Character Selection (Added Ephnel to the selection screen)

# 13.May.2020       
- Added Chii (not fully translated yet since GF doesn't have her Advancement yet)

# 10.May.2020
- forked from <a href="https://github.com/Leayal" target="_blank">Leayal</a> (Base)
